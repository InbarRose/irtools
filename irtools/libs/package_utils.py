...
def apt_get_install(*packages, **kwargs):
    ...
    kwargs.setdefault('trace_file', artifact_dir + '/packages/apt/apt_get_trace.out')
    kwargs.setdefault('dump_file', artifact_dir + '/packages/apt/apt_get_dump.out')
...
def yum_is_installed(package, **kwargs):
    ...
    # kwargs
    kwargs.setdefault('trace_file', artifact_dir + '/packages/yum/yum_trace.out')
    kwargs.setdefault('dump_file', artifact_dir + '/packages/yum/yum_dump.out')
    kwargs.setdefault('dump_file_rotate', True)
    kwargs.setdefault('to_console', False)
...
def verify_pip(get_if_needed=True, raise_on_failure=True, **kwargs):
    ...
    kwargs.setdefault('to_console', False)
    kwargs.setdefault('trace_file', artifact_dir + '/packages/pip/verify_pip.trace.out')
...
def pip_cmd(*packages, **kwargs):
    ...
    # kwargs
    kwargs.setdefault('trace_file', artifact_dir + '/packages/pip/pip_iexec_trace.out')
